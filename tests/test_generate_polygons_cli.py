...
from deafica_waterbodies.cli.generate_polygons import generate_polygons


# Test directory.
HERE = Path(__file__).parent.resolve()
TEST_WATERBODY = os.path.join(HERE, "data", "sm9r6u9c1.parquet")
...
def test_generate_polygons(runner):
    ...
    timeseries_directory = TEST_OUTPUT_DIRECTORY / "timeseries"
